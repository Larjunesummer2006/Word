...
collection = db['Emoji']#TODO: put the name of the collection here
...
@app.route('/How_To_Play_The_Game') 
def renderHowToPlayTheGame():    
    return render_template('How_To_Play_The_Game.html')
...
# format the user data nicely
        ...
        user_data_pprint = '';
    return render_template('Emoji_Game.html', dump_user_data=user_data_pprint)
